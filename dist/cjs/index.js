...
var DragSelectList = function (_a) {
    ...
    var itemsContainerRef = react.exports.useRef(null);
    var _c = react.exports.useState(undefined), selectionBoxStart = _c[0], setSelectionBoxStart = _c[1];
    var _d = react.exports.useState(undefined), selectionBoxEnd = _d[0], setSelectionBoxEnd = _d[1];
    ...
    var calculateSelectionBox = react.exports.useCallback(function () {
    ...
    var _e = react.exports.useState([]), selectedBoxIndices = _e[0], setSelectedBoxIndices = _e[1];
    react.exports.useEffect(function () {
    ...
    return (React.createElement("div", { style: { height: '100%', width: '100%' }, onMouseDown: mouseDownHandler },
        selectionBoxStart && selectionBoxEnd && (React.createElement("div", { style: __assign(__assign({ position: 'absolute', zIndex: 50 }, selectorStyle), calculateSelectionBox()) }, JSON.stringify(calculateSelectionBox()))),
...
exports.DragSelectList = DragSelectList;
exports.DragSelectListItem = DragSelectListItem;
