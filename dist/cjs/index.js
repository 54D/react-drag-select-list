...
var DragSelectListItem = function (_a) {
    ...
    return (React__default["default"].createElement("div", __assign({ key: dataKey, ref: innerRef }, props), children));
};
...
var DragSelectList = function (_a) {
    ...
    var _c = React.useState(undefined), selectionBoxStart = _c[0], setSelectionBoxStart = _c[1];
    var _d = React.useState(undefined), selectionBoxEnd = _d[0], setSelectionBoxEnd = _d[1];
    ...
    var calculateSelectionBox = React.useCallback(function () {
    ...
    var _e = React.useState([]), selectedBoxIndices = _e[0], setSelectedBoxIndices = _e[1];
    React.useEffect(function () {
    ...
    return (React__default["default"].createElement("div", { style: detectionAreaStyle, onMouseDown: mouseDownHandler },
